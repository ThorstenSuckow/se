...
\begin{tcolorbox}[title=extend-Beziehung]
    ...
    Hierbei kann \code{A} alleine oder zusammen mit \code{B} ausgeführt werden (im Unterschied zur \code{include}-Beziehung: Hier ist inkludieren nicht optional) (vgl.~\cite[54]{Bal05}).
