...
\newglossaryentry{Dynamischer Test}
{
...
\newglossaryentry{Vollständige Evaluation}
{
singular={Vollständige Evaluation},
plural={Vollständige Evaluation},
name={Vollständige Evaluation},
description={
Alle Bedingungen einer zsuammengesetzten Entscheidung werden evaluiert.\\
...
\newglossaryentry{Unvollständige Evaluation}
{
...
Wird in der deutschsprachigen Fachliteratur (bspw. von \textit{Liggesmeyer} in \cite{Lig09}) gleichbedeutung zu der \textbf{Kuzschlussauswertung} (\textit{short-circuit-evaluation}) verwendet. Unvollständige Evaluation wird bspw. in \textbf{Java} durch die booleschen Operatoren \textcolor{blue}{\&\&} bzw. \textcolor{blue}{||} erreicht:
