...
Eine Auswahl wichtigster Analysemuster in der o.a standardisierten Beschreibung findet sich in~\cite[22 ff.]{Wed09b} und wird wie folgt verkürzt wiedergegeben.
...
\subsubsection*{Lösung}
\begin{itemize}
    \item Klassen werden von eine Superklasse \code{Node} abgeleitet
    \item Klassen, die andere Klassen referenzieren können, \code{SuperiorNode}'s, besitzen Referenzen auf \code{Node}'s
