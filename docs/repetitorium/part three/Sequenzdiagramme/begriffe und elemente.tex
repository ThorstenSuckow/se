...
Der Name des Operators wird in der linken oberen Ecke des Interaktionsrahmen angegeben (s. Abbildung ~\ref{fig:interaktionsrahmen}, anstelle von \code{sd}).\\
Folgende Bezeichner können für den Operator angegeben werden:

\begin{itemize}
    \item \code{alt} - es können mehrere Abläufe definiert werden
    \item \code{loop} - mehrere Ausführungen, die von einer Bedingung gesteuert werden
    \item \code{op} - Ausführung, wenn eine geg. Bedingung zutrifft
