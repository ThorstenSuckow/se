...
%--------------------------------------------------------------------------
	...
	\address{\begin{center}
				 \small{24.06.2024\\  Thorsten Suckow-Homberg, \url{https://thorsten.suckow-homberg.de}}
...
% Die Kapitel werden in separaten .tex-Dateien abgelegt und hier eingebunden.
	\input{part one/teil1}
	\input{part one/Software und Software Engineering/index}
	\input{part one/Uebersicht ueber die Phasen des Entwicklungszyklus/index}
	\input{part one/Prozessmodelle/index}
	\input{part one/Requirements Engineering/index}

	\input{part two/teil2}
	\input{part two/Objektorientierte Analyse/index}
	\input{part two/Architektur/index}
	\input{part two/Objektorientierter Entwurf/index}

	\input{part three/teil3}
	\input{part three/Einführung/index}
	\input{part three/Klassendiagramme/index}
	\input{part three/Sequenzdiagramme/index}
	\input{part three/Klassendiagramme - Erweiterte Konzepte und Paketdiagramme/index}
	\input{part three/Anwendungsfalldiagramm/index}
	\input{part three/Aktivitätsdiagramme/index}
	\input{part three/Zustandsautomaten/index}

	\input{part four/teil4}
	\input{part four/Qualität/index}
	\input{part four/Typen von Qualitätsmaßnahmen/index}
	\input{part four/Manuelle Verfahren/index}
	\input{part four/Werkzeuggestützte Analyse/index}
	\input{part four/Testende Verfahren/index}
	\input{part four/Management des QS-Prozesses/index}
