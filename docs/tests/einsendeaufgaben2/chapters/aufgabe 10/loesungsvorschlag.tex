...
\begin{itemize}
    ...
    \item Prinzip des \textbf{Information Hiding} / der \textbf{Datenkapselung} ist verletzt, da auf das Attribut \code{price} eines Objekts der Klasse \code{Item} direkt zugegriffen werden kann.
